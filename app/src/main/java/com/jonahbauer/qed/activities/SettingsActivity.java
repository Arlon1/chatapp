...
public class SettingsActivity extends AppCompatPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (sharedPreferences.getAll().get(key) instanceof String) {
            this.sharedPreferences.edit().putString(key,sharedPreferences.getString(key,"")).apply();
        } else if (sharedPreferences.getAll().get(key) instanceof Boolean) {
        ...
        } else if (sharedPreferences.getAll().get(key) instanceof Long) {
            this.sharedPreferences.edit().putLong(key,sharedPreferences.getLong(key,0L)).apply();
        } else if (sharedPreferences.getAll().get(key) instanceof Set<?>) {
    ...
    public static class ChatPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference(getString(R.string.preferences_name_key)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.preferences_channel_key)));
        }
